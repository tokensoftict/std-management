...
Route::get('/', 'IntroController@index')->name('home-page');
Route::match(['get', 'post'], '/check-result', 'IntroController@checkCurrentTermResult')->name('check-result');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['namespace' => 'SupportTeam',], function(){
        ...
        Route::group(['prefix' => 'students'], function(){
            ...
            Route::match(['get', 'post'], 'bulk-upload/{class_id}/{section_id}', 'StudentRecordController@upload_student')->name('students.upload')->middleware('teamSAT');
            Route::match(['get', 'post'], 'download-template/{class_id}/{section_id}', 'StudentRecordController@download_template')->name('students.download_template')->middleware('teamSAT');
...
/************************ SUPER ADMIN ****************************/
Route::group(['namespace' => 'SupportTeam','middleware' => 'super_admin', 'prefix' => 'super_admin'], function(){
