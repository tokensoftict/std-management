...
class MarkController extends Controller
{
    ...
    public function update(Request $req, $exam_id, $class_id, $section_id, $subject_id)
    {
        ...
        foreach($marks->sortBy('user.name') as $mk)
        {
            ...
            $d2['h_score'.$exam->term] = $this->mark->getHigestScore($mk->student_id, $exam, $class_id, $subject_id, $this->year);
            $d2['class_av'.$exam->term] =  $this->mark->getAverageScore($mk->student_id, $exam, $class_id, $subject_id, $this->year);
