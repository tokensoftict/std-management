...
<div class="assessment-container">
    ...
    <div class="assessment-col">
        <div class="rating-legend">
            RATINGS: 1 - Has no degree for observable trait. 2 - Shows minimal record for observable trait. 3 -
            Maintains acceptable level of observed trait. 4 - Maintains a high degree of observed trait. 5 - Maintains
            an excellent degree of observed trait.
        </div>
        <h4>AFFECTIVE ASSESSMENT</h4>
        <div
            style="display: flex; justify-content: flex-end; gap: 12px; font-size: 10px; font-weight: 800; padding-right: 15px; margin-bottom: 5px;">
        ...
        <div
            style="text-align: right; margin-top: 10px; font-weight: 800; font-size: 12px; color: var(--secondary-blue);">
            Affective Score -
        </div>
    </div>
    ...
    <div class="assessment-col">
        ...
        @foreach ($skills->where('skill_type', 'PS') as $ps)
            ...
            <div class="trait-grid-row {{ $loop->even ? 'row-even' : 'row-odd' }}">
                ...
                <div class="rating-options">
                    @for($i = 1; $i <= 5; $i++)
                        <div class="circle-rating {{ $rating == $i ? '' : '' }}"></div>
                    @endfor
                </div>
            </div>
        @endforeach
