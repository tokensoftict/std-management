                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <img src="{{ \App\Repositories\SettingRepo::getlogo() }}" width="100" alt="School Logo" class="logo">
                            ...
                            <div class="form-group ">
                                <input type="text" class="form-control" name="identity" value="{{ old('identity') }}" placeholder="Admission Number or Email Address">
                            </div>
