                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" required name="adm_no" placeholder="Admission Number" class="form-control" value="<?php echo e(old('adm_no')); ?>">
                            </div>
                        </div>
                    </div>
                </fieldset>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yusufolatunji/MyProject/Saas/lav_sms/resources/views/pages/support_team/students/add.blade.php ENDPATH**/ ?>