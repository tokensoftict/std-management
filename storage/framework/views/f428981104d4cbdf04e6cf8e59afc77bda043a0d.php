                    ...
                    <div class="card-body">
                        <div class="row">
                            <div style="font-size: 16px;" class="col-md-10 offset-md-1">
                                ...
                                <p>These terms of use are entered into by and between You and <?php echo e($app_name); ?> ("we" or "us"). The following terms and conditions and all documents incorporated by reference (collectively, "Terms of Use"), govern your access to and use of <a target="_blank" href="<?php echo e($app_url); ?>"><?php echo e($app_url); ?></a>, including any content, functionality and services offered on or through <a target="_blank" href="<?php echo e($app_url); ?>"><?php echo e($app_url); ?></a> (the "Website").</p>

                                <p>Please read the Terms of Use carefully before you start to use the Website. By using the Website, you accept and agree to be bound and abide by these Terms of Use and our Privacy Policy, found at <a target="_blank" href="<?php echo e(route('privacy_policy')); ?>"><?php echo e(route('privacy_policy')); ?></a>, incorporated herein by reference. If you do not want to agree to these Terms of Use or the Privacy Policy, you must not access or use the Website.</p>
                               ...
                               <p>The Website and its entire contents, features and functionality (including but not limited to all information, software, text, displays, images, video and audio, and the design, selection and arrangement thereof), are owned by us, our licensors, or other providers of such material and are protected by United States and international copyright, trademark, patent, trade secret and other intellectual property or proprietary rights laws.</p>
                                ...
                                <ul>
                                    ...
                                    <li>Use the Website in any manner that violates any applicable <?php echo e($app_name); ?> policy, rule, or procedure.</li>
                               ...
                               <p> Without limiting the foregoing, we have the right to fully cooperate with any law enforcement authorities or court order requesting or directing us to disclose the identity or other information of anyone posting any materials on or through the Website.</p>
                                ...
                                <p>YOU WAIVE AND HOLD HARMLESS <?php echo e(strtoupper($app_name)); ?> FROM ANY CLAIMS RESULTING FROM ANY ACTION TAKEN BY <?php echo e(strtoupper($app_name)); ?> DURING OR AS A RESULT OF ITS INVESTIGATIONS AND FROM ANY ACTIONS TAKEN AS A CONSEQUENCE OF INVESTIGATIONS BY <?php echo e(strtoupper($app_name)); ?> OR LAW ENFORCEMENT AUTHORITIES.</p>
                                ...
                                <p>All information we collect on this Website is subject to our Privacy Policy. By using the Website, you consent to all actions taken by us with respect to your information in compliance with the <a target="_blank" href="<?php echo e(route('privacy_policy')); ?>">Privacy Policy</a>.</p>
                                ...
                                <p>YOUR USE OF THE WEBSITE, ITS CONTENT AND ANY SERVICES OR ITEMS OBTAINED THROUGH THE WEBSITE IS AT YOUR OWN RISK. THE WEBSITE, ITS CONTENT AND ANY SERVICES OR ITEMS OBTAINED THROUGH THE WEBSITE ARE PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS, WITHOUT ANY WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED. NEITHER <?php echo e(strtoupper($app_name)); ?> NOR ANY PERSON ASSOCIATED WITH <?php echo e(strtoupper($app_name)); ?> MAKES ANY WARRANTY OR REPRESENTATION WITH RESPECT TO THE COMPLETENESS, SECURITY, RELIABILITY, QUALITY, ACCURACY OR AVAILABILITY OF THE WEBSITE. WITHOUT LIMITING THE FOREGOING, NEITHER <?php echo e(strtoupper($app_name)); ?> NOR ANYONE ASSOCIATED WITH <?php echo e(strtoupper($app_name)); ?> REPRESENTS OR WARRANTS THAT THE WEBSITE, ITS CONTENT OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE WEBSITE WILL BE ACCURATE, RELIABLE, ERROR-FREE OR UNINTERRUPTED, THAT DEFECTS WILL BE CORRECTED, THAT OUR SITE OR THE SERVER THAT MAKES IT AVAILABLE ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS OR THAT THE WEBSITE OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE WEBSITE WILL OTHERWISE MEET YOUR NEEDS OR EXPECTATIONS.</p>

                                <p><?php echo e(strtoupper($app_name)); ?> HEREBY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, STATUTORY OR OTHERWISE, INCLUDING BUT NOT LIMITED TO ANY WARRANTIES OF NON-INFRINGEMENT.</p>

                                <p>THE FOREGOING DOES NOT AFFECT ANY WARRANTIES WHICH CANNOT BE EXCLUDED OR LIMITED UNDER APPLICABLE LAW.</p>

                                <h4 class="font-weight-semibold">Limitation on Liability</h4>

                                <p>IN NO EVENT WILL <?php echo e(strtoupper($app_name)); ?>, ITS AFFILIATES OR THEIR LICENSORS, SERVICE PROVIDERS, EMPLOYEES, AGENTS, OFFICERS OR DIRECTORS BE LIABLE FOR DAMAGES OF ANY KIND, UNDER ANY LEGAL THEORY, ARISING OUT OF OR IN CONNECTION WITH YOUR USE, OR INABILITY TO USE, THE WEBSITE, ANY WEBSITES LINKED TO IT, ANY CONTENT ON THE WEBSITE OR SUCH OTHER WEBSITES OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE WEBSITE OR SUCH OTHER WEBSITES, INCLUDING ANY DIRECT, INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO, PERSONAL INJURY, PAIN AND SUFFERING, EMOTIONAL DISTRESS, LOSS OF REVENUE, LOSS OF PROFITS, LOSS OF BUSINESS OR ANTICIPATED SAVINGS, LOSS OF USE, LOSS OF GOODWILL, LOSS OF DATA, AND WHETHER CAUSED BY TORT (INCLUDING NEGLIGENCE), BREACH OF CONTRACT OR OTHERWISE, EVEN IF FORESEEABLE.</p>
                                ...
                                <p>You agree to defend, indemnify and hold harmless <?php echo e($app_name); ?>, its affiliates, licensors and service providers, and its and their respective officers, directors, employees, contractors, agents, licensors, suppliers, successors and assigns from and against any claims, liabilities, damages, judgments, awards, losses, costs, expenses or fees (including reasonable attorneys' fees) arising out of or relating to your violation of these Terms of Use or your use of the Website, including, but not limited to, your User Contributions, any use of the Website's content, services and products other than as expressly authorized in these Terms of Use or your use of any information obtained from the Website.</p>
                                ...
                                <p>No waiver of by <?php echo e($app_name); ?> of any term or condition set forth in these Terms of Use shall be deemed a further or continuing waiver of such term or condition or a waiver of any other term or condition, and any failure of <?php echo e($app_name); ?> to assert a right or provision under these Terms of Use shall not constitute a waiver of such right or provision.</p>

                                <p>If any provision of these Terms of Use is held by a court or other tribunal of competent jurisdiction to be invalid, illegal or unenforceable for any reason, such provision shall be eliminated or limited to the minimum extent such that the remaining provisions of the Terms of Use will continue in full force and effect.</p>

                                <h4 class="font-weight-semibold">Entire Agreement</h4>

                                <p>These Terms of Use and our <a target="_blank" href="<?php echo e(route('privacy_policy')); ?>">Privacy Policy</a> constitute the sole and entire agreement between you and <?php echo e($app_name); ?> with respect to the Website and supersede all prior and contemporaneous understandings, agreements, representations and warranties, both written and oral, with respect to the Website.</p>
                                ...
                                <p>This website is operated by <?php echo e($app_name); ?>.</p>

                                <p>All other feedback, comments, requests for technical support and other communications relating to the Website should be directed to the School Administrator. Please call <?php echo e($contact_phone); ?></p>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.login_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yusufolatunji/MyProject/Saas/lav_sms/resources/views/pages/other/terms_of_use.blade.php ENDPATH**/ ?>