            ...
            <div class="row">
               ...
               <fieldset>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label font-weight-semibold">Principal Signature:</label>
                        <div class="col-lg-9">
                            <div class="mb-3">
                                <img style="width: 100px" height="100px" src="<?php echo e($s['principal_sign']); ?>" alt="">
                            </div>
                            <input name="principal_sign" accept="image/*" type="file" class="file-input" data-show-caption="false" data-show-upload="false" data-fouc>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yusufolatunji/MyProject/Saas/lav_sms/resources/views/pages/super_admin/settings.blade.php ENDPATH**/ ?>