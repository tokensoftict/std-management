                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select id="name" name="name" class="form-control">
                                            ...
                                            <?php $__currentLoopData = $general_subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e(old('name') == $subject->name ? "selected" : ""); ?> value="<?php echo e($subject->name); ?>"><?php echo e($subject->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yusufolatunji/MyProject/Saas/lav_sms/resources/views/pages/support_team/subjects/index.blade.php ENDPATH**/ ?>